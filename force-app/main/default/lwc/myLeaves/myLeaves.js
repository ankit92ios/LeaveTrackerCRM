...
const COLUMNS = [
    {label : 'Reqeuest Id', fieldName: 'Name', cellAttributes: { class: { fieldName: 'cellClass' } } },
...
export default class MyLeaves extends LightningElement {
    ...
    submitHandler(event) {
        ...
        if (new Date(fields.From_Date__c) > new Date(fields.To_Date__c) ) {
            this.showToastMessage('From Date should not be greater then to date', 'Error', 'error');
    ...
    showToastMessage(message, title ='success', variant = 'success') {
